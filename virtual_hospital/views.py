...
def newappointment():
    time_slot_data = AppointmentTimeSlot.query.filter_by().first()
    return render_template('newappointment.html', currPage='Book an Appointment', time_slot_data = time_slot_data)
